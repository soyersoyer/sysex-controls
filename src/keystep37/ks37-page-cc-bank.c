...
G_DEFINE_FINAL_TYPE (Ks37PageCcBank, ks37_page_cc_bank, SC_TYPE_PREFERENCES_PAGE)
...
ks37_page_cc_bank_class_init (Ks37PageCcBankClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/hu/irl/sysex-controls/keystep37/ks37-page-cc-bank.ui");
}
