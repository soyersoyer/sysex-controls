...
int ks37_midi_read_control(snd_seq_t *seq, snd_seq_addr_t addr, uint16_t control_id, uint8_t *val);
int ks37_midi_write_control(snd_seq_t *seq, snd_seq_addr_t addr, uint16_t control_id, uint8_t val);
