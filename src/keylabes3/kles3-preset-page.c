...
#include "preset/kles3-knob-page.h"
#include "preset/kles3-led-color.h"
#include "preset/kles3-main-knob-page.h"
#include "preset/kles3-pad.h"
#include "preset/kles3-pad-page.h"
#include "preset/kles3-pitch-mod-page.h"
