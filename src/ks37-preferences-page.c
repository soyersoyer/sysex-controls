...
static void
ks37_preferences_page_get_property (GObject    *object,
				    guint       prop_id,
				    GValue     *value,
				    GParamSpec *pspec)
{
...
static void
ks37_preferences_page_set_property (GObject      *object,
				    guint         prop_id,
				    const GValue *value,
				    GParamSpec   *pspec)
{
...
static void
ks37_preferences_page_class_init (Ks37PreferencesPageClass *klass)
{
...
static void
ks37_preferences_page_init (Ks37PreferencesPage *self)
{
}
